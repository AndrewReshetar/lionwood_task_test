    ...
    <NavStyle>
      <div className="links">
        <ul>
          ...
          <li>
            <NavLink to="/create_character">Create a character</NavLink>
          </li>
        </ul>
      </div>
          ...
          <form>
            ...
            <div className="status">
              <input
                ...
                name="status"
                id="alive"
                checked={statusRadion === 'alive'}
                onChange={(e) => setStatusRadio(e.target.value)}
              />
